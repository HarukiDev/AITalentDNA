            ...
            <header className="flex justify-between items-center mb-12">
                ...
                <div className="flex justify-between items-center mb-4 border-b">
                    <div className="flex space-x-4">
                        <a href="#" className="text-blue-500 py-2">Job Fit</a>
                        <a href="#" className="text-gray-700 py-2">Culture Fit</a>
                    </div>
                    <div className="py-2 text-gray-500">Home/Job Fit</div>
                </div>
                <div className="flex justify-between items-center mb-5">
                    <div>
                        <h2 className="text-[30px] font-semibold">Job Fit</h2>
