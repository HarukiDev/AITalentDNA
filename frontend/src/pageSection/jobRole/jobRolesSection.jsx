...
export default function JobRolesPage({
  ...
  return (
    <div className="min-h-screen p-0 bg-transparent">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-800 sm:text-3xl">Job Roles</h1>
                ...
                {currentItems.length > 0 ? (
                  currentItems.map((jobRole) => (
                    <tr key={jobRole.id} className="hover:bg-gray-100">
                      <td className="p-3">{jobRole.name}</td>
                  ...
                  <tr>
                    <td colSpan="4" className="p-5 italic text-center text-gray-500" style={{ fontSize: '1.1rem', fontWeight: '500' }}>
