...
export default function deleteCoreValue({ isOpen, onClose, onDelete, coreValue }) {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500 bg-opacity-50">
        <div className="relative w-full max-w-md p-6 bg-white rounded-lg shadow-2xl">
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h3 className="mb-4 text-xl font-semibold text-gray-800">Delete Core Value</h3>
            <p className="mb-6 text-gray-600">Are you sure you want to delete the core value <strong>{coreValue.name}</strong>?</p>
